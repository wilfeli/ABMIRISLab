...
namespace solar_core
{
    ...
    /**
     ...
     Utility - param - already connected amount of energy, param - potential amount of energy that could be connected (also add inflation to that), chances of connecting will depend on the difference between the two.
     
     Degradation of PV - 0.5% per year
     
     @DevStage1 Check that payment is before or after installation
