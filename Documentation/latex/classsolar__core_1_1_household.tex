...
\item[\hyperlink{_dev_stage2__DevStage2000007}{Dev\+Stage2}]might change from actually assigning house to assigning house type (memory considerations)\end{DoxyRefDesc}
...
\hypertarget{classsolar__core_1_1_household_a5f84bf614d0ec70abf9597ec97e07b1a}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!Household@{Household}}
\index{Household@{Household}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
\subsubsection[{Household}]{\setlength{\rightskip}{0pt plus 5cm}Household\+::\+Household (
\begin{DoxyParamCaption}
\item[{{\bf Property\+Tree} \&}]{pt\+\_\+, }
\item[{{\bf W} $\ast$}]{w\+\_\+}
\end{DoxyParamCaption}
)}\label{classsolar__core_1_1_household_a5f84bf614d0ec70abf9597ec97e07b1a}
Creation and initialization section

\begin{DoxyRefDesc}{Dev\+Stage2}
\item[\hyperlink{_dev_stage2__DevStage2000008}{Dev\+Stage2}]need destructor, copy constructor, copy assignment operator, move constructor, move assignment operator\end{DoxyRefDesc}
...
Definition at line 27 of file H.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsolar__core_1_1_household_a5f84bf614d0ec70abf9597ec97e07b1a_cgraph}
\end{center}
\end{figure}
...
Section relevant to marketing informationimplements actions for requesting marketing information 

Implements \hyperlink{classsolar__core_1_1_i_agent_a0333116b8ef74f3321ce7acff5d5332e}{solar\+\_\+core\+::\+I\+Agent}.



Definition at line 96 of file H.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsolar__core_1_1_household_add38a49b76c2836a50a89e75318414f1_cgraph}
\end{center}
\end{figure}
...
\item[\hyperlink{_dev_stage2__DevStage2000004}{Dev\+Stage2}]think about moving difference to the virtual call. For now it is explicit, as it is assumed that agents themselves realize that it will be online vs offline quote \end{DoxyRefDesc}


Definition at line 103 of file H.\+cpp.
...
Definition at line 366 of file H.\+cpp.
...
generic actions on a tick, specialize for each type of agents \begin{DoxyRefDesc}{Dev\+Stage2}
\item[\hyperlink{_dev_stage2__DevStage2000006}{Dev\+Stage2}]generally actions in a tick depend on the state of an agent, either it is choosing installer or waiting for the project to finish. Might have a call back to w that will indicate that this agent has changed state. In this case w will have multiple lists of agents in different states and would call appropriate function. Or might do it internally where new state will dictate behavior in the tick. Generally have both -\/ agent is broadcasting changed state and behaves differently depending on the state. \end{DoxyRefDesc}
...
Definition at line 398 of file H.\+cpp.
...
\hypertarget{classsolar__core_1_1_household_aaa1f1e52009d8aef32d3c5a9367b93b7}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!dec\+\_\+evaluate\+\_\+designs@{dec\+\_\+evaluate\+\_\+designs}}
\index{dec\+\_\+evaluate\+\_\+designs@{dec\+\_\+evaluate\+\_\+designs}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
\subsubsection[{dec\+\_\+evaluate\+\_\+designs}]{\setlength{\rightskip}{0pt plus 5cm}void Household\+::dec\+\_\+evaluate\+\_\+designs (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}\label{classsolar__core_1_1_household_aaa1f1e52009d8aef32d3c5a9367b93b7}
Section relevant to design stagepicks best design according to the internal preferences

\begin{DoxyRefDesc}{Dev\+Stage2}
\item[\hyperlink{_dev_stage2__DevStage2000005}{Dev\+Stage2}]may go back and forth over the design\end{DoxyRefDesc}


Definition at line 264 of file H.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsolar__core_1_1_household_aaa1f1e52009d8aef32d3c5a9367b93b7_icgraph}
\end{center}
\end{figure}
...
Section with agent\textquotesingle{}s internals //internal preferences? what is the difference between this section and parameters of Heveluate online quotes -\/ which to be persued further 

Definition at line 167 of file H.\+cpp.
...
Definition at line 206 of file H.\+cpp.
...
\begin{DoxyRefDesc}{Dev\+Stage2}
\item[\hyperlink{_dev_stage2__DevStage2000009}{Dev\+Stage2}]need to ask H\+H how they decide to reroof \end{DoxyRefDesc}


Definition at line 357 of file H.\+cpp.
...
receives marketing information No mutex guards as only other operation is popping from the front, which does not invalidate anything

\begin{DoxyRefDesc}{Dev\+Stage2}
\item[\hyperlink{_dev_stage2__DevStage2000003}{Dev\+Stage2}]might be add saving of the time of the marketing message, in this case it will be saved in the form of transformed marketing messages because original message will time stamped at the moment of creation (almost at the beginning of the simulation) \end{DoxyRefDesc}
...
Definition at line 71 of file H.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=332pt]{classsolar__core_1_1_household_ac9d26af7b52f0cdc357fc5dca4b86ad9_cgraph}
\end{center}
\end{figure}
...
will this include parameters about utility of cost considerations? will this just incorporate initial quoting or the revised quoting following the site visitfirst request for information from \hyperlink{classsolar__core_1_1_s_e_i}{S\+E\+I}, provides basic information such as credit score and etc. Some parameters need to be taken from \hyperlink{classsolar__core_1_1_house}{House} directly, they are pushed to the general container when changed 

Definition at line 316 of file H.\+cpp.
...
\hypertarget{classsolar__core_1_1_household_ab8c15758602643f2290ef1b9ddf2a2ca}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!init@{init}}
\index{init@{init}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
\subsubsection[{init}]{\setlength{\rightskip}{0pt plus 5cm}void Household\+::init (
\begin{DoxyParamCaption}
\item[{{\bf W} $\ast$}]{w\+\_\+}
\end{DoxyParamCaption}
)}\label{classsolar__core_1_1_household_ab8c15758602643f2290ef1b9ddf2a2ca}


Definition at line 64 of file H.\+cpp.
...
Definition at line 296 of file H.\+cpp.
...
Definition at line 309 of file H.\+cpp.
...
Definition at line 303 of file H.\+cpp.
...
Definition at line 332 of file H.\+cpp.
...
Definition at line 339 of file H.\+cpp.
...
Definition at line 450 of file H.\+cpp.



\subsection{Friends And Related Function Documentation}
\hypertarget{classsolar__core_1_1_household_a44ca6974a1749c689f90065d1232facd}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!W@{W}}
\index{W@{W}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
\subsubsection[{W}]{\setlength{\rightskip}{0pt plus 5cm}friend class {\bf W}\hspace{0.3cm}{\ttfamily [friend]}}\label{classsolar__core_1_1_household_a44ca6974a1749c689f90065d1232facd}


Definition at line 49 of file H.\+h.
...
Definition at line 163 of file H.\+h.
...
Definition at line 282 of file H.\+h.
...
\hypertarget{classsolar__core_1_1_household_ad7ec15745665433a5f9f174e8618bdc7}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!project\+\_\+states\+\_\+to\+\_\+delete@{project\+\_\+states\+\_\+to\+\_\+delete}}
\index{project\+\_\+states\+\_\+to\+\_\+delete@{project\+\_\+states\+\_\+to\+\_\+delete}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
...
Definition at line 221 of file H.\+h.
...
Definition at line 262 of file H.\+h.
...
\hypertarget{classsolar__core_1_1_household_a7c0f5fb9f84a1d971e770fc677e7d8de}{}\index{solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}!T\+H\+E\+T\+A\+\_\+design@{T\+H\+E\+T\+A\+\_\+design}}
\index{T\+H\+E\+T\+A\+\_\+design@{T\+H\+E\+T\+A\+\_\+design}!solar\+\_\+core\+::\+Household@{solar\+\_\+core\+::\+Household}}
...
Definition at line 318 of file H.\+h.
